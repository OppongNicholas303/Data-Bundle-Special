...
import com.space.space_bundle.service.EmailService;
...
public class EmailExceptionTestApp {
     ...
     */
    private static void testWebhookProcessingException(EmailService emailService) {
        ...
        try {
            ...
            emailService.send(TEST_EMAIL, subject, body);
     ...
     */
    private static void testSignatureVerificationFailure(EmailService emailService) {
     ...
     */
    private static void testOrderProcessingException(EmailService emailService) {
     ...
     */
    private static void testTopUpException(EmailService emailService) {
     ...
     */
    private static void testMultipleExceptions(EmailService emailService) {
