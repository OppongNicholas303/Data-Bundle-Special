...
public class TransactionService {
    ...
    public Transaction createDebitTransaction(String userId, String orderId, BigDecimal amount, String description) {
    ...
    public Transaction createCreditTransaction(String userId, String orderId, BigDecimal amount, String description) {
        Transaction transaction = Transaction.builder()
                .id(UUID.randomUUID().toString())
                .userId(userId)
                .orderId(orderId)
    ...
    public Transaction createRefundTransaction(String userId, String orderId, BigDecimal amount, String description) {
        Transaction transaction = Transaction.builder()
                .id(UUID.randomUUID().toString())
                .userId(userId)
                .orderId(orderId)
